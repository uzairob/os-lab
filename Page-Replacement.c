...
void fifo(int F[], int n, int P[], int m) {
    ...
    printf("The Page Replacement Process using FIFO is:\n");
...
void lru(int F[], int n, int P[], int m) {
    ...
    printf("The Page Replacement Process using LRU is:\n");
...
void optimal(int F[], int n, int P[], int m) {
    ...
    printf("The Page Replacement Process using Optimal is:\n");
